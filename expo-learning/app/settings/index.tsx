  ...
  return (
    <>
      <View style={styles.container}>
        ...
        {/* <View style={[styles.settingsContainer, { marginTop: 30 }]}>
          <FlatList
            data={settingsData.list2}
            renderItem={({ index, item }) => (
              <View style={styles.settingsTextContainer}>
                <View
                  style={{
                ...
                <View
                  style={[
                    styles.listItem,
                    index < settingsData.list2.length - 1 && {
                      borderBottomWidth: 1,
                    },
                  ]}
                >
...
const styles = StyleSheet.create({
  ...
  // settingsIcon: { flexDirection: "row", gap:4, alignItems: "center" },
  listItem: {
    flex: 1,
    flexDirection: "row",
